...
class TestCourseSearchTool:
    ...
    def test_execute_vector_store_error(self, course_search_tool):
        ...
        course_search_tool.store.search.return_value = SearchResults.empty("Database connection failed")
    ...
    def test_format_results_with_links(self, course_search_tool):
        ...
        course_search_tool.store.get_course_link.return_value = "https://example.com/course"
        ...
        expected_sources = [
            ...
            {"text": "ML Course - Lesson 2", "url": "https://example.com/lesson1"}  # Mock returns same link
        ]
    ...
    def test_format_results_course_level_content(self, course_search_tool):
        ...
        expected_source = {"text": "Overview Course", "url": "https://example.com/course"}
