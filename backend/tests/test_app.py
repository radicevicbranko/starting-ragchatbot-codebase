...
class TestQueryEndpoint:
    ...
    def mock_app(self):
        ...
        with patch('app.RAGSystem') as mock_rag_class:
            ...
            mock_rag = Mock()
            mock_rag.query.return_value = ("Test response", [{"text": "Test Course", "url": "https://example.com"}])
    ...
    def test_query_without_session(self, mock_app):
        ...
        mock_rag.query.assert_called_once_with("What is machine learning?", "test-session-123")
    ...
    def test_query_with_session(self, mock_app):
        ...
        mock_rag.query.assert_called_once_with("Follow up question", "existing-session-456")
...
class TestAppStartup:
    ...
    def test_startup_with_docs_folder(self, mock_rag_class, mock_exists):
        ...
        mock_rag.add_course_folder.assert_called_once_with("../docs", clear_existing=False)
...
class TestErrorHandling:
    ...
    def test_courses_unexpected_error(self, error_app):
        ...
        # Configure RAG to raise unexpected error
        mock_rag.get_course_analytics.side_effect = ValueError("Analytics computation error")
