...
"""
    ...
    def _execute_sequential_rounds(self, messages: List[Dict], system_content: str, 
        ...
        while current_round < max_rounds:
            ...
            termination_result = self._check_termination_conditions(response, current_round, max_rounds)
    ...
    def _check_termination_conditions(self, response, current_round: int, max_rounds: int) -> Dict[str, Any]:
        """
        ...
        for content_block in response.content:
            if content_block.type == "tool_use":
                try:
                    ...
                    error_msg = f"Failed to execute tool '{content_block.name}': {str(e)}"
    ...
    def _extract_text_response(self, response) -> str:
        ...
        return "".join(text_parts) if text_parts else "I don't have a clear answer to provide."
    
    def _make_final_call_without_tools(self, messages: List[Dict], system_content: str) -> str:
